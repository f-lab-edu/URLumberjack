...
public class LumberjackServiceMockTest {
    ...
    @Test
    @DisplayName("URL 단축 재귀 함수의 호출이 10회를 넘어가면, RecursiveCallExceedException이 발생한다.")
    public void when_recursiveFunctionCallOverTen_expect_throwsRecursiveCallExceedException() {
        ...
        // 예외가 발생하는지 검증
        assertThrows(RecursiveCallExceedException.class, () -> {
